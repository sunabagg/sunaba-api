...
class VisualShaderNodeVaryingGetterVaryingType {
...
@:native("godot.VisualShaderNodeVaryingGetter")
extern class VisualShaderNodeVaryingGetter extends VisualShaderNodeVarying {
    @:native("__new")
    public function new();
}
