...
class ReferenceRectLayoutDirection {
...
class ReferenceRectSizeFlagsHorizontal {
...
class ReferenceRectSizeFlagsVertical {
    public static var ShrinkBegin: Int = 0;
    public static var Fill: Int = 1;
    public static var Expand: Int = 2;
    public static var ExpandFill: Int = 3;
...
class ReferenceRectTooltipAutoTranslateMode {
