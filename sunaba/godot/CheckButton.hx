...
class CheckButtonTextOverrunBehavior {
...
class CheckButtonIconAlignment {
    public static var Left: Int = 0;
    public static var Center: Int = 1;
    public static var Right: Int = 2;
    public static var Fill: Int = 3;
...
class CheckButtonVerticalIconAlignment {
...
class CheckButtonTextDirection {
